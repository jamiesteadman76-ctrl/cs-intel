        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 md:pt-20 pb-12 md:pb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
              {[
                { label: 'Total Members', value: communityStats.totalMembers.toLocaleString(), icon: '👥' },
                { label: 'Active Now', value: communityStats.activeUsers.toLocaleString(), icon: '🟢' },
                { label: 'Posts Today', value: communityStats.postsToday.toLocaleString(), icon: '📝' },
                { label: 'Comments Today', value: communityStats.commentsToday.toLocaleString(), icon: '💬' },
              ].map((stat, index) => (
                <div
                  key={index}
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  {communityDiscussions.slice(0, 4).map((discussion, index) => (
                    <div
                      key={discussion.id}
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-gray-400">
                          <span className="text-[#00d4ff] font-semibold">{category.discussions.toLocaleString()}</span> discussions
                        </span>
              ...
              <section>
                ...
                <div className="bg-gradient-to-br from-[#1a1f2e] to-[#0f1419] border border-gray-700 rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 border-t border-gray-800">
                    <button className="w-full py-2.5 text-sm font-medium text-gray-300 hover:text-white border border-gray-700 rounded-lg hover:border-gray-600 transition-colors">
                      Load More Posts
                    </button>
                  </div>
                </div>
              ...
              <section>
                <div className="mb-6">
                  ...
                  <p className="text-gray-400 text-sm mt-1">Our most valued community members</p>
                </div>

                <div className="bg-gradient-to-br from-[#1a1f2e] to-[#0f1419] border border-gray-700 rounded-lg overflow-hidden">
                  {/* Header row */}
                  <div className="grid grid-cols-12 gap-2 px-5 md:px-6 py-3 border-b border-gray-800 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                    <div className="col-span-1">Rank</div>
                    <div className="col-span-4 md:col-span-3">User</div>
                    <div className="col-span-3 text-center hidden sm:block">Reputation</div>
                    <div className="col-span-2 text-center hidden sm:block">Posts</div>
                    <div className="col-span-2 text-center hidden md:block">Predictions</div>
                  ...
                  {topContributors.map((contributor) => (
                    <div
                      ...
                      className="grid grid-cols-12 gap-2 px-5 md:px-6 py-4 border-b border-gray-800 last:border-b-0 hover:bg-[#1a1f2e]/50 transition-colors items-center"
                    >
                      <div className="col-span-1">
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-xs ${
                            contributor.rank <= 3
                              ? 'bg-gradient-to-br from-[#e94560] to-[#ff6b6b]'
                              : 'bg-[#1a1f2e] border border-gray-600'
                          }`}
                        >
                          {contributor.rank}
                        </div>
                      ...
                      <div className="col-span-4 md:col-span-3 flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#e94560] to-[#ff6b6b] flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                          {contributor.avatar}
                        </div>
                      ...
                      <div className="col-span-2 text-center text-sm text-gray-300 hidden sm:block">
                        {contributor.posts}
                      </div>
                      <div className="col-span-2 text-center text-sm text-gray-300 hidden md:block">
                        ...
                        <div className="inline-flex items-center gap-1.5">
                          <div className="w-16 h-1.5 bg-[#1a1f2e] rounded-full overflow-hidden">
                            <div
                              ...
                              style={{ width: `${contributor.accuracy}%` }}
                            />
                          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-[#1a1f2e] to-[#0f1419] border border-gray-700 rounded-lg p-5 md:p-6">
                  ...
                  {trendingMatches.map((match) => (
                    ...
                    >
                      <div className="flex items-center gap-2 flex-1 min-w-0">
                        <span className="text-sm">{match.logo1}</span>
                      ...
                      <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                        ...
                        <span className="text-sm">{match.logo2}</span>
                      </div>
                    </div>
                  ))}
                </div>
                <div className="mt-4 space-y-1">
                  {trendingMatches.map((match) => (
                    <div key={`time-${match.team1}`} className="flex justify-between text-xs text-gray-500">
                  ...
                  {topContributors.slice(0, 5).map((contributor) => (
                    <div key={contributor.rank} className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">{contributor.reputation.toLocaleString()} rep</p>
                      </div>
                      <span className="text-xs font-semibold text-[#00d4ff]">{contributor.accuracy}%</span>
                    </div>
                  ))}
                </div>
              </div>
